			...
			<section
				...
				<div className="container mx-auto px-4 text-center">
					...
					<p className="text-lg mb-6">
						I'm a frontend developer with expertise in technologies like React,
						JavaScript, CSS/SASS node and MongoDB. I focus on delivering
						efficient, high-quality, and user-friendly web solutions.
					</p>
					<a
						href="/about"
